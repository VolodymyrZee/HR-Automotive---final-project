...
public class LoginController {
	...
	@Autowired
	public LoginController(UserService userService, CarService carService, CarServicesService carServicesService,
	...
	@PostMapping("login")
	public String signin(@RequestParam String email, WebRequest request, @RequestParam String password, Model model) {
		try {
	...
	public String userpro(@RequestParam long id, Model model) {

		try {
			model.addAttribute("profiles", userService.findById(id).get());

			model.addAttribute("carServices",
					carServicesService.findAllByCarServicesByUser(userService.findById(id).get()));
